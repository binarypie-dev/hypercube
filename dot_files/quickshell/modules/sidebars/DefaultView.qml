...
// Default sidebar view with quick settings, calendar, weather, and notifications
Flickable {
    id: root
    ...
    ColumnLayout {
        ...
        // Calendar section
        SidebarSection {
            title: Services.DateTime.dateString || "Calendar"
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Text {
                    Layout.fillWidth: true
                    horizontalAlignment: Text.AlignHCenter
                    text: (Services.DateTime.monthNames ? Services.DateTime.monthNames[displayMonth] : "") + " " + displayYear
                    font.family: Common.Appearance.fonts.main
                    font.pixelSize: Common.Appearance.fontSize.normal
                    font.weight: Font.Medium
                    color: Common.Appearance.m3colors.onSurface
